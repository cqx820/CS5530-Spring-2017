...
<title>Highest Rate</title>
</head>
<body>
<h1>Highest Rate TH</h1>
...
result=t.getHighestRate(amount, con.stmt);

out.println("Here are top Highest Rate TH <br><br>");
for (String s[] : result) {
	out.println("Name: " + s[0] + "<br>");
	out.println("Category: " + s[1] + "<br>");
	out.println("AveScore: " + s[2] + "<br>");
	out.println( "<br>");
	out.println( "<br>");
}
			}
